...
let inputAngka = 0;
console.log(inputAngka == 0 ? `Angka ${inputAngka} adalah Nol` : inputAngka > 0 ? `Angka ${inputAngka} adalah bilangan positif` : `Angka ${inputAngka} adalah bilangan negatif`);
...
if (diskon != 0) {
    console.log(`Anda membeli ${jumlahBarang} ${namabarang} dengan harga ${hargaBarang} per-${namabarang}, Total harga sebelum diskon ${totalPembelian}`);
...
function hitungKapital(str) {
    ...
    console.log(`Jumlah huruf kapital pada test ${str} adalah : ${jumlahKapital}`);
}
